...
import type { ColorButtonKey } from '@/shared/interfaces'
...
const CardBoxModal = ({
  ...
  return (
    ...
    >
      <CardBox
        className="transition-transform shadow-lg z-50 w-[95%] sm:w-[90%] md:w-[80%] lg:w-[70%] max-h-[90vh] overflow-hidden"
        isModal
        footer={footer}
      >
